const OkLogo = ({ className="h-24", brand=false, compact=false }) => (
  <svg version="1.1" viewBox={compact ? "5 6 60 53" : "4 -24 62 90"} xmlns="http://www.w3.org/2000/svg" className={className}>
